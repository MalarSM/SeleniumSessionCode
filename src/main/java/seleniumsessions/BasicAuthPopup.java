...
public class BasicAuthPopup {
	...
	public static void main(String[] args) {
		...
		//Not JS Popup
		//Authentication (popup) - Basic Authentication popup
		//supply username and password within the URL only
		//Auth popups are not JS alret so cannot switch
		//only one @ allowed in the URL
		//@ problem solved in the Selenium 4.x : HasAuthenticated
