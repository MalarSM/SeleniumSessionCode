...
public class ImplicitlyWait {
	...
	public static void main(String[] args) {
		...
		//It can be applied for all the webelement
		//It can not be applied for the specific webelement
		//It can not be applied for non webelements: title, url, windows, JS popups
